            ...
            Row(
                ...
                if (inPeriod) {
                    Button(
                        ...
                        SmallSpacer(4)
                        Text(stringResource(R.string.home_end_period), style = MaterialTheme.typography.labelMedium)
                    }
                } else {
                    Button(
                        ...
                        SmallSpacer(4)
                        Text(stringResource(R.string.btn_record_period), style = MaterialTheme.typography.labelMedium)
                    }
                }
            }
        }
